...
import History from './pages/History';   // ✅ Naya add kiya
import Profile from './pages/Profile';   // ✅ Naya add kiya
import Transfer from './pages/Transfer'; // ✅ Naya add kiya
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/admin/withdrawals" element={<ProtectedRoute><AdminWithdraw /></ProtectedRoute>} />
